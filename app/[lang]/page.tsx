...
const serviceCards = {
  ja: [
    ...
    },
    {
      ...
      title: 'AIをプロダクトの一部に',
      body: 'すごいデモで終わらせず、体験・データ・業務をつなぎ、毎日使うプロダクトにします。',
      fitBullets: ['AIを活かした新規サービスを作りたい', '既存プロダクトにAIを組み込みたい', '業務知見をプロダクトに活かしたい'],
      proofLine: '例：顧客サービス、社内ツール、ナレッジ活用',
    ...
    },
    {
      ...
      title: 'AIを開発・実現の主力に',
      body: '構想のまま止まったアイデアを、AI駆動開発で速さと品質を両立して実装します。',
  ...
  en: [
    ...
    },
    {
      ...
      body: 'Beyond a demo that wows once — we connect experience, data, and work into a product people use every day.',
    ...
    },
    {
      ...
      body: 'We move ideas stuck on a slide into a running product, with AI-driven delivery that holds speed and quality together.',
