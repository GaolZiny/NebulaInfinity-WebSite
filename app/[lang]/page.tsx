...
const serviceCards = {
  ja: [
    ...
    },
    {
      ...
      title: 'AIをプロダクトの一部に',
      body: 'すごいデモで終わらせず、体験・データ・業務との接続まで設計し、毎日使われるプロダクトに仕上げます。',
      fitBullets: ['AIを活かした新規サービスを作りたい', '既存プロダクトにAIを組み込みたい', '業務知見をプロダクトに活かしたい'],
      proofLine: '例：顧客向けサービス、社内ツール、ナレッジ活用',
    ...
    },
    {
      ...
      title: 'AIを開発・実現の主力に',
      body: '構想のままで止まったアイデアを、AI駆動の開発体制で、速さと品質を両立して動く形まで進めます。',
      fitBullets: ['構想を素早く動くMVPにしたい', '開発の個人依存や手戻りを減らしたい', '短いサイクルで実装したい'],
      proofLine: '例：最短24時間MVP、アジャイル型開発',
  ...
  en: [
    ...
    },
    {
      ...
      body: 'Beyond a demo that wows once — we connect experience, data, and real work, and finish it into a product people use every day.',
      ...
      proofLine: 'Examples: customer services, internal tools, knowledge use',
    ...
    },
    {
      ...
      body: 'We move ideas stuck on a slide into a running product — with an AI-driven delivery model that holds speed and quality together.',
      ...
      proofLine: 'Examples: MVP in as little as 24 hours, agile development',
