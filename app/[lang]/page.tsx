...
const valuePanels = {
  ja: [
    { title: '属人ノウハウを、組織の資産に', body: '担当者に閉じた判断基準や手順を可視化し、組織が運用・進化できる仕組みへ変えます。' },
  ...
  en: [
    { title: 'Turn tacit know-how into a company asset', body: "We surface the decision rules and steps locked in one person's head, and rebuild them into a system your organization can run and improve." },
