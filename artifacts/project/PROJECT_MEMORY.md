...
- 2026-05-05: Z approved Services/About as Home anchors and clarified standalone Services index and About pages may be deleted (not compatibility pages); revised proposal is in progress as `task-166`. Z also requested Home `#about` not repeat Focus/Representative products and keep working principles in current style.
